...
describe("#View - test suite for presentation layer", () => {
  ...
  function makeBtnElement(
    ...
    return { onClick: jest.fn(), classList, innerText: text };
  }
  ...
  test("#changeCommandButtonsVisibility - given hide=true it should add unassigned class to all command buttons and reset onclick", () => {
    const view = new View();
  ...
  test("#changeCommandButtonsVisibility - given hide=false it should remove unassigned class to all command buttons and reset onclick", () => {
    const view = new View();
    const btn = makeBtnElement();
